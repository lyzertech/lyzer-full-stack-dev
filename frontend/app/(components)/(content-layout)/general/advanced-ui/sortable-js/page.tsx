...
import {
  ...
  Drag8,
  Drag9,
} from '@/shared/data/general/advance-ui/sortablejsdata'
            ...
            <Card.Body>
              ...
              >
                <ReactSortable
                  ...
                  list={simpleList}
                  setList={setsimpleList}
                  group="shared"
                  animation={200}
                  easing="ease-out"
                >
                  {simpleList.map((item) => (
                    <ListGroup.Item className="" as="li" key={item.id}>
                      {item.name}
                    </ListGroup.Item>
                  ))}
                </ReactSortable>
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <ReactSortable
                ...
                handle=".handle"
                animation={150}
                className="list-group sortable-list list-item-numbered sortable-with-handle"
                tag="ol"
              >
                {sortlist.map((item) => (
                  <li
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <div
                id="nestedSortables"
                className="list-group col nested-sortable"
              >
                <ReactSortable
                  filter=".addImageButtonContainer"
                  dragClass="sortableDrag"
                          ...
                          {item.children.map((child) => (
                            <div
                              ...
                              className={`list-group-item nested-2 ${
                                child.children ? 'nested-2' : ''
                              }`}
                              draggable={
                                child.draggable === false ? 'false' : 'true'
                              }
                            >
                              {child.name}
                              {child.children && (
