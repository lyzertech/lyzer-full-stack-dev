    ...
    <Fragment>
      ...
      <Row>
        ...
        <Col xxl={6}>
          <Card className="custom-card">
            <Card.Header>
              <div className="card-title">School Revenue</div>
            </Card.Header>
            <Card.Body>
      ...
      <Row>
        <Col xxl={3}>
          <Card className="custom-card">
            <Card.Header>
              <div className="card-title">Students Activity</div>
            </Card.Header>
            <Card.Body>
        ...
        <Col xxl={3}>
          <Card className="custom-card">
            <Card.Header>
              <div className="card-title">Students Overview</div>
            </Card.Header>
            <Card.Body>
              <div id="students-overview">
                <Spkapexcharts
                  ...
                  type={'donut'}
                  width={'100%'}
                  chartOptions={SchoolOverviewOptions}
                  chartSeries={SchoolOverviewSeries}
                />
              </div>
            </Card.Body>
            <Card.Footer>
              <Row className="g-0">
                <div className="col border-end border-inline-end-dashed">
                  <div className="text-center">
                    ...
                    <h5 className="mb-0 mt-1 fw-semibold d-flex align-items-center justify-content-center gap-1">
                      6560
                  ...
                  <ListGroup.Item key={student.id} className="">
                    <div className="d-flex align-items-center gap-2">
                      ...
                      <div className="text-end">
                        ...
                        <span
                          className={`${student.achievementClass} fs-13 d-block`}
                        >
                          {student.achievement}
                        </span>
                      </div>
        ...
        <Col xxl={3}>
          <Card className="custom-card overflow-hidden">
            <Card.Header className="justify-content-between">
              <div className="card-title">Students Fee Analytics</div>
              <Link scroll={false} href="#!" className="text-muted fs-13">
                View All<i className="ti ti-arrow-narrow-right ms-1"></i>
              </Link>
            </Card.Header>
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            ...
                            <div>
                              <span className="d-block fw-semibold lh-1 mb-1">
                                {payment.name}
                              </span>
                              <span className="fs-13 text-muted">
                                {payment.feeType}
            ...
            <Card.Body>
              <div id="attendance-overview">
                <Spkapexcharts
                  ...
                  type={'bar'}
                  width={'100%'}
                  chartOptions={SchoolAttendanceOptions}
                  chartSeries={SchoolAttendanceSeries}
                />
              </div>
            </Card.Body>
