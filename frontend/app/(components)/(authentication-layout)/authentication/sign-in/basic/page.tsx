                        ...
                        <Col xxl={4} xl={5} lg={6} md={6} sm={8} className="col-12">
                            <Card className="custom-card border-0 my-4">
                                        ...
                                        <Col xl={12} className="mb-2">
                                            ...
                                            <div className="mt-2">
                                                <div className="form-check">
                                                    ...
                                                    <Link scroll={false} href="/authentication/reset-password" className="float-end link-danger fw-medium fs-12">Forget password ?</Link>
                                                </div>
                                            </div>
                                        </Col>
                                    </div>
                                ...
                                <div className="text-center mt-3 fw-medium">
                                    Don't have an account? <Link scroll={false} href="/authentication/sign-up" className="text-primary">Sign Up</Link>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
