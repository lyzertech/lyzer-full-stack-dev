            ...
            <tr key={index}>
              <td className="ps-4">
                <input
                  ...
                  defaultChecked={
                    job.id == 2 || job.id == 3 || job.id == 6 || job.id == 7
                  }
                />
              </td>
              <td>
                <div className="d-flex align-items-center">
                  <div className="lh-1">
                    <span
                      className={`avatar avatar-md avatar-rounded bg-${job.svgClass}-transparent svg-${job.svgClass}`}
                    >
                      {job.svgIcon}
                    </span>
                  </div>
                  <div className="ms-2">
                    <p className="fw-medium mb-0 d-flex align-items-center">
                      <Link scroll={false} href="/dashboards/jobs/job-details">
                        {job.title}
                      </Link>
                    </p>
              ...
              <td>
                <Link
                  scroll={false}
                  href="/dashboards/jobs/job-details"
