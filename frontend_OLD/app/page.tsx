                      ...
                      <Card.Body className="p-sm-5 ">
                        ...
                        <div className="row gy-3">
                          <Col xl={12}>
                            ...
                            <Form.Control suppressHydrationWarning type="email" name="email" className="signin-email-input" id="email" placeholder="user name"
                              defaultValue={email}
                          ...
                          <Col xl={12} className="mb-2">
                            ...
                            <div className="position-relative">
                              <Form.Control suppressHydrationWarning name="password" type={passwordVisibility.password ? 'text' : 'password'} value={password}
                    ...
                    <Tab.Pane eventKey="firebase" className='border-0'>
                      <Card.Body className="p-sm-5 ">
                        ...
                        <div className="row gy-3">
                          <Col xl={12}>
                            <label htmlFor="signin-email" className="form-label text-default">Email</label>
                            <Form.Control suppressHydrationWarning type="email" name="email" className="" id="email" placeholder="user name"
                              defaultValue={email}
                              onChange={changeHandler}
                            />
                          </Col>
                          <Col xl={12} className="mb-2">
                            <label htmlFor="signin-password" className="form-label text-default d-block">Password</label>
                            <div className="position-relative">
                              <Form.Control suppressHydrationWarning name="password" type={passwordVisibility.passwords ? 'text' : 'password'} value={password}
                                onChange={changeHandler} className="create-password-input" id="signin-password" placeholder="password" />
